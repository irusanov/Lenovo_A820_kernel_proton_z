...
/*#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_ABBYSPLUG)
extern struct cpufreq_governor cpufreq_gov_abbysplug;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_abbysplug)*/
#endif
